...
export const HelpBox: React.FC = () => {
  ...
  const customerRoles: string[] = ['Individual User'];
  const tenantRoles: string[] = ['Owner', 'Administrator', 'Team Member', 'Collaborator'];
  const addOns: string[] = ['notifications', 'file', 'chat'];
  const applicationName = `To do list application`;
